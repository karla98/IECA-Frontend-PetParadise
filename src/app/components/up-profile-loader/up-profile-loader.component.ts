...
@Component({
  selector: 'app-up-profile-loader',
  templateUrl: './up-profile-loader.component.html',
  styleUrls: ['./up-profile-loader.component.scss']
})

export class UpProfileLoaderComponent implements OnInit {
